...
\begin{frame}{Includerea codului metodei în codul auxiliar}
    \begin{figure}[htb]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \includegraphics[height=2in]{../../../theses/diploma/src/img/incorporate-before-white-24.png}
            \caption{Înainte}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \includegraphics[height=2.67in]{../../../theses/diploma/src/img/incorporate-after-white-32.png}
            \caption{După}
        \end{subfigure}%
        }\\
