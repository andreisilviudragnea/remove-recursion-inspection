...
of the code. Since the main purpose of the refactoring is to avoid \code{StackOverflowError}s, the performance of the
transformed method may be worse than the performance of the original one.
